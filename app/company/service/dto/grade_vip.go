...
type GradeVipGetPageReq struct {
	...
	BeginTime      string `form:"beginTime" search:"type:gte;column:created_at;table:grade_vip" comment:"创建时间"`
	EndTime        string `form:"endTime" search:"type:lte;column:created_at;table:grade_vip" comment:"创建时间"`
