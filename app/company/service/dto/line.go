...
type LineGetPageReq struct {
	...
	ExpirationTime  string `form:"expiration_time" search:"type:gte;column:expiration_time;table:line" comment:"创建时间"`
	Effective bool `json:"effective" form:"effective" search:"-"`
	LineOrder
}
